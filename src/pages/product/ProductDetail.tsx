    ...
    return (
        <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
            ...
            {props.data && props.data.map((item, index) => {
                return <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6" key={index}>
                    <div className="border-b border-gray-200 pb-6">
                        {/* <p className="text-sm leading-none text-gray-900 dark:text-gray-600 "></p> */}
                        <h1 className="lg:text-2xl text-xl font-semibold lg:leading-6 leading-7 text-gray-900 dark:text-gray-600 mt-2">{item.name}</h1>
                    </div>
                    <div>
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 dark:text-gray-600">{item.price} đ</p>
